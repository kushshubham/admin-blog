   ...
   <Footer className="border border-t-8 border-teal-500">
      <div className="w-full max-w-7xl max-auto">
        ...
        Blog
          ...
          <div className="grid grid-cols-2 gap-3 sm: mt-4 
          sm:grid-cols-3 sm:gap-6">
           ...
           <Footer.Title title="Follow us"/>
            <Footer.LinkGroup col>
            <Footer.Link href="https://www.github.com/kushshubham"
            target="_blank"
            rel="noopener noreferrer">
              Github
            </Footer.Link>
        ...
        <div className="w-full sm:flex sm:items-center sm:justify-between">
          <Footer.Copyright href="#" by="Admin's blog" year={new Date().getFullYear()}/>
